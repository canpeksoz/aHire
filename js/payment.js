...
paypalPayment.addEventListener('click',(e)=>{
  ...
  var row = "<tr> <td>" +  snapshot.val().title + "</td> <td>" + snapshot.val().category + "</td> <td>" + snapshot.val().date + "</td>  <td>" + snapshot.val().price + "</td> <td>" +
   "</td> <td>" +
   "<a class='btn btn-info' target='__blank' href='employerProofofWork.html'>Check Proof Of Work</a>" + "</td>" + "<td>" + "<a class='btn btn-info' id='paypalPayment'target='__blank' href='paymentSection.html'>Go Payment</a>" + "</td></tr>" 
  $(row).appendTo('#jobs');
